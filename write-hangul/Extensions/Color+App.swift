...
extension Color {
    ...
    static let appInk = Color(red: 0.18, green: 0.20, blue: 0.22)
    static let appMuted = Color(red: 0.42, green: 0.46, blue: 0.48)
    static let appAccent = Color(red: 0.29, green: 0.57, blue: 0.42)
    static let appTile = Color(red: 0.98, green: 0.98, blue: 0.96)
